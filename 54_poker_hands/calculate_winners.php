...
// get hands from file
$hands = array();
$filename = dirname(__FILE__) . '/poker.txt';
...
foreach ($hands as $hand) {
    ...
    // get winner
    $winners = PokerHand::getWinnerHands(array(
        PokerHand::getInstance($player1)->getHandInfo(),
        PokerHand::getInstance($player2)->getHandInfo()
    ));
